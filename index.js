...
async function searchGoogleMaps(query) {
    try {
        ...
        await writeFile('./data/results.json', JSON.stringify(buisnesses), 'utf-8', (err) => {
            if (err) throw err;
...
const query = "Hotels within Nairobi County";
await searchGoogleMaps(query);